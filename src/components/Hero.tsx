...
export default function Hero() {
  return (
    <section className="w-full relative pt-32 pb-10 md:pt-40 md:pb-15 bg-white overflow-hidden animate-hero-section opacity-0">
      <div className="w-full mx-auto px-4 md:px-8 lg:px-10 pb-0">
        <div className=" relative w-full max-w-[1376px] h-[200px] sm:h-[260px] md:h-[340px] lg:h-[404px] rounded-[20px] overflow-hidden flex items-center justify-center animate-hero-card opacity-0">
